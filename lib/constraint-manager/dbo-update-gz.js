...
const { validateTimeHorizon, checkConstraintVersion } = require("./c-validator");
...
module.exports.main = async (constraintData) => {
  ...
  const { error: errorUpdate, data: dataUpdate, message: messageUpdate } = await updateConstraint(constraint_id, extents, 'Accepted', old_version, uss_base_url, constraint_type, false); // 'false' -> collision validation off
  if (errorUpdate) {
...
//   "constraint_id": "010314e0-4899-46e9-84c4-82bccbf3ed8f",
//   "extents": [{
//     "time_end": {
//       "format": "RFC3339",
//       "value": "2020-03-21T04:26:24Z"
//     },
//     "time_start": {
//       "format": "RFC3339",
//       "value": "2020-03-20T04:26:24Z"
//     },
//     "volume": {
//       "altitude_lower": {
//         "reference": "W84",
